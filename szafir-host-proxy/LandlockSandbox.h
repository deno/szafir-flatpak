...
// home, xdgDataHome, and xauthority MUST be pre-captured in the parent before fork.
// xauthority may be an empty string if $XAUTHORITY is unset (rule is skipped).
